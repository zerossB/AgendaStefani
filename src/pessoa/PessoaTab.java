 ...
 * @author JSQLGen
 */
public class PessoaTab extends javax.swing.JDialog {
    private final java.sql.Connection connection;
    private final java.util.List list;

    /** Construtor do form PessoaTab
     * @param parent
     * @param connection
     */
    public PessoaTab(java.awt.Window parent, java.sql.Connection connection) {
        super(parent);
    ...
    public static void showDialog(java.awt.Window parent, java.sql.Connection connection){
        new PessoaTab(parent, connection);
    }
    ...
    private void refresh() {
        ...
        list.removeAll(list);
        list.addAll(PessoaDAO.loadView(connection));
    ...
    private void bAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAddActionPerformed
        ...
        pessoa = PessoaForm.showInputDialog(this, connection, pessoa);
        if(pessoa!=null) {
            try {
                PessoaDAO.insert(connection, pessoa);
                refresh();
    ...
    private void bRemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRemActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                Pessoa pessoa = PessoaDAO.loadById(connection, (Integer)tTable.getValueAt(tTable.getSelectedRow(), 0));
                if(javax.swing.JOptionPane.showConfirmDialog(this, "Deseja excluir o Pessoa "+pessoa.getId()+"?","Questão",javax.swing.JOptionPane.OK_CANCEL_OPTION)==javax.swing.JOptionPane.OK_OPTION) {
                    PessoaDAO.delete(connection, pessoa);
    ...
    private void bEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEditActionPerformed
        if(tTable.getSelectedRow()>=0) {
            try {
                ...
                pessoa = PessoaForm.showInputDialog(this, connection, pessoa);
                if(pessoa!=null) {
                    PessoaDAO.update(connection, pessoa);
                    refresh();
                }
            } catch(java.sql.SQLException e){
                e.printStackTrace();
    ...
    private void bPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bPrintActionPerformed
        ...
        print += "<caption>Tabela de Pessoa</caption>";
        print += "<tr>";
